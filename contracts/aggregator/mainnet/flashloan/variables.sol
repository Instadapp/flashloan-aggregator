...
import {ListInterface, IAaveLending, IERC3156FlashLender, Comptroller, IBalancerLending, IWeth} from "./interfaces.sol";
...
contract ConstantVariables {
    ...
    address public constant makerLendingAddr =
        0x1EB4CF3A948E7D72A198fe073cCb8C7a948cD853;
    IERC3156FlashLender public constant makerLending =
        IERC3156FlashLender(makerLendingAddr);
    ...
    address public constant cDaiToken =
    ...
    address public constant comptrollerAddr =
