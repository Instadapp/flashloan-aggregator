...
describe("FlashLoan Compound(using MakerDAO)", function () {
    let Resolver, resolver, Receiver, receiver;
    const DAI = "0x6b175474e89094c44da98b954eedeac495271d0f";
    const USDT = "0xdac17f958d2ee523a2206206994597c13d831ec7";
    const ACC_DAI = "0x9a7a9d980ed6239b89232c012e21f4c210f4bef1";
    ...
    describe("Single token", async function() {
        it("Should be able to take flashLoan of a single token from Compound(Using MakerDAO)", async function () {
    ...
    describe("Multi token", async function() {
        it("Should be able to take flashLoan of multiple tokens together from Compound(Using MakerDAO)", async function () {
...
describe("FlashLoan Aave(using MakerDAO)", function () {
    let Resolver, resolver, Receiver, receiver;
    const DAI = "0x6b175474e89094c44da98b954eedeac495271d0f";
    const USDT = "0xdac17f958d2ee523a2206206994597c13d831ec7";
    const ACC_DAI = "0x9a7a9d980ed6239b89232c012e21f4c210f4bef1";
    ...
    describe("Single token", async function() {
        it("Should be able to take flashLoan of a single token from Aave(Using MakerDAO)", async function () {
    ...
    describe("Multi token", async function() {
        it("Should be able to take flashLoan of multiple tokens together from Aave(Using MakerDAO)", async function () {
