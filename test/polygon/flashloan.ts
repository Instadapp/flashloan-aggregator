...
describe("FlashLoan", function () {
  ...
  describe("Single token", async function () {
    ...
    it("Should be able to take flashLoan of a single token from own Flashloan Route", async function () {
      await receiver.flashBorrow([DAI], [1], 9, _data, _instaData);
    });
  ...
  describe("Multi token", async function () {
    ...
    it("Should be able to take flashLoan of multiple tokens together from own Flashloan Route", async function () {
      await receiver.flashBorrow([DAI, USDT], [1, 1], 9, _data, _instaData);
    });
